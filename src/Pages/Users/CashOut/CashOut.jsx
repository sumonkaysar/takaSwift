...
const CashOut = () => {
  ...
  const handleCashOut = (data) => {
    ...
    if ((data.amount + data.amount * 0.015) > user.balance) {
  ...
  return (
    <div>
      ...
      <form className="mx-auto lg:w-[800px] w-11/12" onSubmit={handleSubmit(handleCashOut)}>
        <h4 className="mb-3 text-lg">Your Current Balance: <b>{user?.balance} Taka</b></h4>
        <div className="form-control">
          <div>
            <label htmlFor="mobile" className="label">Agent Number</label>
            <input
